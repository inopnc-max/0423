...
// NEXT_PUBLIC_KAKAO_CHANNEL_PUBLIC_ID - 카카오채널 공식 계정 ID (예: 'xfgxdqX' 또는 '_xfgxdqX')
// NEXT_PUBLIC_KAKAO_CHANNEL_CHAT_URL - 카카오채널 채팅 URL (선택, 미설정 시 자동 생성)
const RAW_KAKAO_CHANNEL_ID =
  process.env.NEXT_PUBLIC_KAKAO_CHANNEL_PUBLIC_ID || '_xfgxdqX'

// ID 정규화: 항상 '_xfgxdqX' 형태를 보장
const KAKAO_CHANNEL_PUBLIC_ID = RAW_KAKAO_CHANNEL_ID.startsWith('_')
  ? RAW_KAKAO_CHANNEL_ID
  : `_${RAW_KAKAO_CHANNEL_ID}`

const KAKAO_CHAT_URL =
  process.env.NEXT_PUBLIC_KAKAO_CHANNEL_CHAT_URL ||
  `https://pf.kakao.com/${KAKAO_CHANNEL_PUBLIC_ID}/chat`
